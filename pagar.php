...
if(isset($_POST['submit'])):             
    ...
    try {
        ...
        pases_articulos, talleres_registrados, regalo, total_pagado,pagado) VALUES(?,?,?,?,?,?,?,?,?)");              
...
$compra = new Payer();
$compra->setPaymentMethod('paypal'); //  Usar el valor

// echo $compra->getPaymentMethod('paypal');// GET Ver el valor
...
$listaAticulos = new ItemList();
$listaAticulos->setItems($arreglo_pedido);
